# ==============================================================================
#  Luacord — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection Luacord de Discord
#
...
$InstallDir    = Join-Path $env:LOCALAPPDATA "Luacord-Client"
...
Write-Host "  ║      LUACORD — Désinstalleur           ║" -ForegroundColor Cyan
Write-Host "  ╚══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  │  Luacord désinstallé avec succès !                 │" -ForegroundColor Green
