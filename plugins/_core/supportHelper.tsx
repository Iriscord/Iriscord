...
const AdditionalAllowedChannelIds = [
    "1024286218801926184", // Iriscord > #bot-spam
];
...
async function generateDebugInfoMessage() {
    ...
    const commonIssues = {
        ...
        "Iriscord DevBuild": !IS_STANDALONE,
            ...
            if (!IS_UPDATER_DISABLED) {
                ...
                if (isOutdated) {
                    openModal(props => (
                        ...
                        >
                            <div>
                                <Forms.FormText>You are using an outdated version of Iriscord! Chances are, your issue is already fixed.</Forms.FormText>
                                <Forms.FormText className={Margins.top8}>
    ...
    renderContributorDmWarningCard: ErrorBoundary.wrap(({ channel }) => {
        ...
        return (
            <Card variant="warning" className={Margins.top8} defaultPadding>
                Please do not private message Iriscord plugin developers for support!
                <br />
                Instead, use the Iriscord support channel: {Parser.parse("https://discord.com/channels/1015060230222131221/1026515880080842772")}
