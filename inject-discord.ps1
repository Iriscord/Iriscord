# ==============================================================================
#  Luacord — Script d'injection Post-Installation
#  Utilisé par l'installateur Inno Setup pour injecter Luacord dans Discord.
# ==============================================================================
...
# On pointe vers le patcher.js dans le dossier d'installation de Luacord
$LuacordPatcher = Join-Path $AppDir "dist\desktop\patcher.js"
$LuacordPatcher = $LuacordPatcher.Replace("\", "\\")
...
// Injection Luacord
try {
    require(\"$LuacordPatcher\");
} catch (e) {
    console.error(\"Luacord injection failed:\", e);
