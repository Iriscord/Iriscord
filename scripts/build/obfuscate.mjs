// @ts-check
/*
 * Luacord — Post-build obfuscation
...
// ─── Fichiers ciblés ────────────────────────────────────────────────────────
// dist/js/   → buildDesktop (app Luacord elle-même)
...
// dist/desktop/ et dist/luacord/ → build.mjs (asar vencord)
const ASAR_JS_FILES = [
    "patcher.js",
    "preload.js",
    "renderer.js",
 ...
 * @param {string} dir  ex: "dist/desktop" ou "dist/luacord"
 */
