...
import { BackupRestoreIcon, LogIcon, MainSettingsIcon, ThemesIcon, CreateThemeIcon, PatchHelperIcon, PluginsIcon, UpdaterIcon, MagnifyingGlassIcon } from "@components/Icons";
import IconsTab from "@luacordplugins/iconViewer/components/IconsTab";
...
import { CreateThemeTab } from "@luacordplugins/createTheme/components/CreateThemeTab";
...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Luacord settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("Luacord_stealthMode") === "1") return ""; } catch { }
                return "Luacord Settings";
            },
            buildLayout: () => {
                try { if (localStorage.getItem("Luacord_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`Luacord ${gitHashShort}${getVersionInfo()}`];
