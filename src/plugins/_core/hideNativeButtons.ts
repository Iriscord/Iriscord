/*
 * Luacord — Injection CSS globale pour masquer les boutons natifs Discord
 */

import { Devs } from "@utils/constants";
import definePlugin from "@utils/types";

const STYLE_ID = "luacord-hide-native-buttons";

const CSS = `
/* ── Luacord : suppression boutons natifs Discord non désirés ── */
