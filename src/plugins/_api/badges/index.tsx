...
let LuacordBadges = {} as Record<string, Array<Record<"tooltip" | "badge", string>>>;
...
async function loadAllBadges(noCache = false) {
    ...
    const luacordBadges = await loadBadges("https://gist.githubusercontent.com/luacordoff/29ff0da4ebd5a7e36acdf97be24f28c9/raw/badges.json", noCache).catch(() => ({}));

    DonorBadges = vencordBadges;
    EquicordDonorBadges = equicordBadges;
    LuacordBadges = luacordBadges;
}
...
export default definePlugin({
    ...
    getLuacordBadges(userId: string) {
        try {
            const userBadges = LuacordBadges[userId];
            ...
            for (const badge of userBadges) {
                ...
                results.push({
                    iconSrc: iconSrc,
                    description: (badge as any).tooltip || (badge as any).description || (badge as any).label || "Luacord Badge",
