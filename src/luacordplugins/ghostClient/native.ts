 ...
 * Lance ghost-server via node.exe bundlé dans luacord-dist
...
// Handler IPC pour ouvrir les URLs externes (utilisé par LuacordUpdater)
ipcMain.handle("LUACORD_OPEN_URL", (_event, url: string) => {
