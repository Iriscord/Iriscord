...
const DS_KEY_TOKENS = "luacord-ghost-tokens";
const DS_KEY_AUTO_FOLLOW = "luacord-ghost-autofollow";
const DS_KEY_MIC_DEVICE = "luacord-ghost-mic-device-label";
const DS_KEY_SELECTED = "luacord-ghost-selected";
