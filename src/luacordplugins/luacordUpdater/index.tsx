...
const REMOTE_VERSION_URL =
    "https://api.github.com/repos/luacordoff/luacord/releases/latest";
...
async function checkForUpdates() {
    try {
        ...
        console.log(`[LuacordUpdater] local=${localVersion} remote=${remoteVersion}`);
        ...
        console.error("[LuacordUpdater] Error vérification:", e);
    }
}
...
function UpdateBanner() {
    ...
    async function doUpdate() {
        ...
        try {
            ...
            setTimeout(() => {
                try {
                    VencordNative.luacord?.relaunch?.();
                } catch {
            ...
            console.error("[LuacordUpdater] Error mise à jour:", e);
    ...
    return React.createElement("div", {
        ...
        React.createElement("div", {
            ...
            React.createElement("span", { style: { fontWeight: 700, flexShrink: 0 } },
                `🔔 Luacord ${info.remoteVersion} available!`
            ),
...
function mountBanner() {
    if (bannerContainer || document.getElementById("luacord-updater-root")) return;
    bannerContainer = document.createElement("div");
    bannerContainer.id = "luacord-updater-root";
    ...
    try {
        ...
        console.error("[LuacordUpdater] Error montage bannière:", e);
    }
}
