...
export default definePlugin({
    name: "UserAreaTweaks",
    description: "Creates an elegant floating dock for Luacord plugins using pure CSS, preventing overlap and crashes.",
    authors: [{ name: "Luacord", id: 0n }],
    enabledByDefault: true,

    start() {
        const style = document.createElement("style");
        style.id = "luacord-userarea-tweaks-style";
        style.textContent = CSS;
        document.head.appendChild(style);
    },

    stop() {
        document.getElementById("luacord-userarea-tweaks-style")?.remove();
    }
});
