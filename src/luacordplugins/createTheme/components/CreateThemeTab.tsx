    ...
    return (
        <div className={cl("root")}>
            ...
            <div className={cl("section")}>
                ...
                <div className={cl("color-card")}>
                    <div className={cl("color-row")}>
                        <div className={cl("color-labels")}>
                            <div className={cl("color-icon-label")}>
                            ...
                            <span className={cl("sublabel")}>Tints every panel, button and link</span>
                        </div>
                        <div className={cl("color-picker-wrapper")}>
                            <input
                                type="color"
                    ...
                    <div className={cl("color-presets")}>
                        {colorPresets.map(preset => (
                            <div
                                key={preset}
                                className={cl("color-preset") + (settings.color.toLowerCase() === preset.replace("#", "").toLowerCase() ? " " + cl("active") : "")}
            ...
            <div className={cl("section")}>
                <div className={cl("toggle-card")}>
                    <label className={cl("live-toggle")}>
                        ...
                        />
                        <span className={cl("toggle-slider")}></span>
                        <span className={cl("toggle-label")}>Enable theme</span>
                    </label>
                </div>
                
                <div className={cl("info-box")}>
                    <div className={cl("info-text")}>
                        When enabled, your theme stays active even after closing this tab or restarting Discord (color &amp; glass only — background image must be re-uploaded each session).
                    </div>
                </div>
            </div>
