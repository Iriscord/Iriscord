/*
 * Luacord - StealthMode plugin
 * Cache tous les boutons de plugins (barre du haut, zone texte, zone utilisateur)
 * Toggle : Ctrl+Shift+H ou bouton dans Luacord Settings.
 *
...
export default definePlugin({
    ...
    description: "Hides all plugin buttons without disabling them. Shortcut: Ctrl+Shift+H. The toggle is in Luacord Settings.",
    ...
    stop() {
        document.body.classList.remove("luacord-stealth");
    },
});
