...
function createLuacordMenuItems(): MenuItemConstructorOptions[] {
    return [
        {
            label: "Luacord",
            submenu: [
                ...
                {
                    label: cachedUpdateAvailable ? "Update Luacord" : "Check for Updates",
...
export function patchTrayMenu(): void {
    // On ne patch plus le menu tray — Luacord gère son propre tray dans patcher.ts
}
