...
export async function downloadVencordAsar() {
    await downloadFile(
        "https://github.com/Luacord/Luacord/releases/latest/download/Luacord.asar",
        VENCORD_DIR,
        {},
...
export function isValidVencordInstall(dir: string) {
    return existsSync(join(dir, "Luacord/main.js"));
}

export async function ensureVencordFiles() {
    if (!existsSync(VENCORD_DIR)) {
        console.error("Bundled luacord.asar not found at", VENCORD_DIR);
    }
}
