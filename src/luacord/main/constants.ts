...
const LuacordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(LuacordDir, "Uninstall Luacord.exe"));

export const DATA_DIR =
    process.env.Luacord_USER_DATA_DIR || (PORTABLE ? join(LuacordDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `Luacord/${app.getVersion()} (https://github.com/Luacord/Luacord)`;
