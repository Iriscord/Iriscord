...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@Luacord/types/components";
import { FluxDispatcher, InviteActions } from "@Luacord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure Luacord and Luacord are fully up to date. You can get help in our{" "}
