...
import { Button, Flex, Heading, Paragraph } from "@Luacord/types/components";
import { ModalContent, ModalFooter, ModalHeader, ModalRoot, ModalSize } from "@Luacord/types/utils";
            ...
            <ModalContent style={{ padding: "16px 24px" }}>
                <div style={{
                    ...
                    <Paragraph style={{ fontWeight: "bold", marginBottom: "6px", color: "var(--text-normal)" }}>
                        LuacordFr is a 100% Free product.
                    </Paragraph>
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                        ...
                        <li style={{ color: "var(--text-normal)" }}>
                            ...
                            <span
                                ...
                                onClick={() => window.open("https://discord.gg/luacord", "_blank")}
                            >
                                discord.gg/luacord
                            </span>
                        </li>
                ...
                <div style={{
                    ...
                    <Paragraph style={{ color: "var(--text-muted)", fontStyle: "italic", fontSize: "13px" }}>
                        <strong>Note:</strong> Only download LuacordFr via our official channels to ensure your security.
                    </Paragraph>
                </div>
            </ModalContent>
