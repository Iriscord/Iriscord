...
import { Button, Card, HeadingTertiary, Paragraph } from "@Luacord/types/components";
import { useAwaiter } from "@Luacord/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your Luacord is outdated!</HeadingTertiary>
