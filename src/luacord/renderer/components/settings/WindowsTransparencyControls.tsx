...
import { Heading, Paragraph } from "@Luacord/types/components";
import { Margins } from "@Luacord/types/utils";
import { Select } from "@Luacord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind Luacord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
