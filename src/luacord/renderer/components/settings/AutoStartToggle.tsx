...
import { useState } from "@Luacord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Luacord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Luacord minimized when starting with system"}
