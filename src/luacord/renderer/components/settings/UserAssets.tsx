...
import { BaseText, Button, FormSwitch } from "@Luacord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@Luacord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`luacord://assets/${asset}?v=${version}`}
                    alt=""
