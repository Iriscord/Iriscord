/*
 * Luacord, a Discord client mod
 * Copyright (c) 2025 Luacord contributors
 * SPDX-License-Identifier: GPL-3.0-or-later
 */

import { BaseButton, BaseText } from "@Luacord/types/components";
import { React, useState, useRef } from "react";

import { cl } from "./Settings";

function detectSource(json: any): "equicord" | "vencord" | "luacord" | "unknown" {
    ...
    // Plugins spécifiques à Luacord
    if (pluginNames.some(p => ["LuacordHelper", "equicordHelper"].includes(p))) return "luacord";
...
function cleanForLuacord(json: any): any {
    ...
    // Supprimer les plugins propres à Equicord/Vencord qui n'existent pas dans Luacord
    ...
    async function processFile(file: File) {
        ...
        try {
            ...
            const sourceLabel =
                ...
                source === "luacord" ? "Luacord" : "inconnu";

            const cleaned = cleanForLuacord(json);
            ...
            setStatus("success");
            setMessage(`✅ Settings ${sourceLabel} importés avec succès ! Redémarre Luacord pour appliquer.`);
        } catch (err: any) {
            setStatus("error");
    ...
    return (
        <div className={cl("category")}>
            ...
            <BaseText size="sm" style={{ marginBottom: "12px", opacity: 0.7 }}>
                Drag & drop your Equicord or Vencord backup JSON file here to import your settings into Luacord.
                Plugin-specific settings that don't exist in Luacord will be automatically removed.
            </BaseText>
