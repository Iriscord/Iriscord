...
import { Logger } from "@Luacord/types/utils";
import { findLazy, onceReady } from "@Luacord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Luacord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("LuacordRPC", "#5865f2");
