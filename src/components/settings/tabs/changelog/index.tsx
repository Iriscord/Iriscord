...
function ChangelogContent() {
    ...
    return (
        <>
            {/* v1.0.0 Initial Release Changelog */}
            <Card className="vc-changelog-v1-release">
                <div style={{
                    padding: "1.5em",
                    ...
                    <div style={{
                        ...
                        <span style={{
                            fontSize: "24px",
                            fontWeight: "700",
                            background: "linear-gradient(90deg, var(--brand-experiment) 0%, #7289da 100%)",
                    ...
                    <Heading style={{ fontSize: "16px", marginBottom: "0.5em" }}>
                        Welcome to Luacord!
                    </Heading>
                    
                    <Paragraph style={{ marginBottom: "1em" }}>
                        The first official release of Luacord brings a beautiful, feature-rich Discord client modification with a focus on customization and user experience.
                    </Paragraph>
                    ...
                    <div style={{
                        ...
                        <div>
                            <Heading style={{ fontSize: "14px", marginBottom: "0.5em", color: "var(--brand-experiment)" }}>
                                ✨ Core Features
                            </Heading>
                            <ul style={{ margin: 0, paddingLeft: "1.5em", fontSize: "14px", lineHeight: "1.8" }}>
                                <li>Beautiful redesigned UI with Discord-style components</li>
                                <li>Custom theme creator with live preview</li>
                                <li>Enhanced plugin system with statistics</li>
                                <li>Multi-instance support for multiple accounts</li>
                                <li>Auto-translate functionality</li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul style={{ margin: 0, paddingLeft: "1.5em", fontSize: "14px", lineHeight: "1.8" }}>
                                <li>Bulk Friend Remove</li>
                                <li>Custom Profile Editor</li>
                                <li>Event Logs</li>
                                <li>Export DM History</li>
                                <li>Mass DM</li>
                                <li>Token Importer</li>
                                <li>Voice Channel Search</li>
                        ...
                        <div>
                            ...
                            <ul style={{ margin: 0, paddingLeft: "1.5em", fontSize: "14px", lineHeight: "1.8" }}>
                                <li>Redesigned settings panel with moon icon</li>
                                <li>Beautiful Quick Actions section</li>
                                <li>Enhanced plugin statistics display</li>
                                <li>Modern theme creator interface</li>
                    ...
                    <div style={{
                        ...
                        <span>
                            Created by <strong style={{ color: "var(--brand-experiment)" }}>luanaticc</strong> • Owner & Developer
                        </span>
                        <span>
            ...
            <Paragraph className={Margins.bottom8}>
                This is the GitHub repository where Luacord fetches updates from.
            </Paragraph>
